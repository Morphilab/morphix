...
Each page documents a layer's public API: classes, functions, methods, and their signatures.

## Layers

| Layer | Modules | Description |
|-------|---------|-------------|
| [Core](core.md) | 37 modules | Database, config, memory, security, MCP, paths, hooks |
